...
public class Invoice extends JFrame {
    ...
    public Invoice(String firstName, String lastName, String address, String phoneNumber, float totalCost, double quantity) {
        ...
        initializeComponents(firstName, lastName, address, phoneNumber, totalCost, quantity);
    ...
    private void initializeComponents(String firstName, String lastName, String address, String phoneNumber, float totalCost, double quantity) {
        ...
        addressLabel.setBounds(X, y, 300, 30);
        y += gap;
