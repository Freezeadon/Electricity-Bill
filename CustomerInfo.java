...
public class CustomerInfo extends JFrame {
    ...
    private JLabel customerIDtext, name, planType, offPeak, midPeak, onPeak, overCosted, delivery, regulatory, HST, subTotal, totalHST;
    private JLabel customerIDNo, firstName, lastName, planValue, offPeakValue, midPeakValue, onPeakValue, overCostedValue, deliveryValue, regulatoryValue,
    ...
    public CustomerInfo(String customerId, String plan, int offPeakTime, int midPeakTime, int onPeakTime, float total, String firstName, String lastName, String address, String phoneNumber) {
        ...
        initializeComponents(customerId, plan, offPeakTime, midPeakTime, onPeakTime, total, firstName, lastName, address, phoneNumber);
    ...
    private void initializeComponents(String customerId, String plan, int offPeakTime, int midPeakTime, int onPeakTime, float total, String firstName, String lastName, String address, String phoneNumber) {
        ...
        name = new JLabel("Name: " + firstName + " " + lastName);
        ...
        customerIDtext.setBounds(35, 15, 150, 30);
        customerIDNo.setBounds(145, 15, 200, 30);

        name.setBounds(35, 35, 200, 30);
        y += gap;
        ...
        invoiceButton.addActionListener(e -> generateInvoice(firstName, lastName, address, phoneNumber, totalChargedWithHST, allTime));
    ...
    private void generateInvoice(String firstName, String lastName, String address, String phoneNumber, float totalChargedWithHST, float allTime) {
